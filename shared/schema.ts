...
export const jobs = pgTable("jobs", {
  ...
  createdAt: timestamp("created_at").defaultNow().notNull(),
  // Fields from n8n ingestion
  description: text("description"),
  jobDescription: text("job_description"),
  companyWebsite: text("company_website"),
  companyLogo: text("company_logo"),
  applyLink: text("apply_link").notNull(),
  applyIsDirect: integer("apply_is_direct"),
  jobIsRemote: integer("job_is_remote"),
  jobPostedAt: text("job_posted_at"),
  jobPostedAtTimestamp: text("job_posted_at_timestamp"),
  jobPostedAtDatetimeUtc: text("job_posted_at_datetime_utc"),
  jobLocation: text("job_location"),
  jobCity: text("job_city"),
  jobState: text("job_state"),
  jobCountry: text("job_country"),
  jobGoogleLink: text("job_google_link"),
  jobSalary: text("job_salary"),
