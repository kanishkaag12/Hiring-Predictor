...
export function WhatIfSimulatorChat() {
  ...
  return (
    <Card className="border-none bg-gradient-to-br from-indigo-900/20 to-purple-900/10 shadow-2xl relative overflow-hidden h-full flex flex-col max-h-[75vh] min-h-[560px]">
